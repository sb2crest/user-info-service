...
import com.user.info.service.util.CommonFunction;
...
import static com.user.info.service.exception.ResStatus.VEHICLE_NOT_FOUND;
import static com.user.info.service.util.ListUtil.collectionAsStream;
